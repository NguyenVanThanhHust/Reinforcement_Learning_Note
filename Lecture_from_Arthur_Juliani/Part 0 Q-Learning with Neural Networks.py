...
"""
We will create a one layer network which take input is state encoded in one hot vector (1x16) and produces a vector of 4 Q values
"""
...
with tf.Session() as sess:
    ...
    for i in range(num_episodes):
        ...
        while j < 99:
            ...
            a,allQ = sess.run([predict,Q_out],feed_dict={inputs:np.identity(16)[s:s+1]})
